        ...
        <div className="space-y-6 text-light-text dark:text-gray-200 font-poppins">
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div className="border-2 border-light-magenta dark:border-warm-yellow rounded-xl p-4">
                <h3 className="font-semibold text-light-magenta dark:text-warm-yellow mb-2 flex items-center gap-2">
