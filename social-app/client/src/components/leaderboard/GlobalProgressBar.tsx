  ...
  return (
    <div className="bg-white dark:bg-charcoal-light border-2 border-light-pink dark:border-vibrant-green rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-lg shadow-light-pink-soft dark:shadow-neon-green">
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-lg sm:text-xl font-poppins font-bold text-transparent bg-gradient-to-r from-vibrant-green to-light-magenta dark:to-warm-yellow bg-clip-text">
          🌍 Globálny Cieľ
        </h3>
      ...
      <div className="mb-3">
        <div className="w-full bg-charcoal rounded-full h-4 sm:h-6 overflow-hidden border border-electric-blue">
          <div
            className="h-full bg-gradient-to-r from-vibrant-green to-light-magenta dark:to-warm-yellow transition-all duration-1000 ease-out relative overflow-hidden"
      ...
      <div className="flex justify-between items-center text-xs sm:text-sm font-poppins">
        ...
        <div>
          ...
          <span className="text-light-magenta dark:text-warm-yellow font-bold">{formatNumber(progress.targetPlayers)}</span>
        </div>
      </div>

      <div className="mt-3 text-center">
        <p className="text-light-text-secondary dark:text-gray-300 font-poppins text-xs sm:text-sm">
          <span className="text-light-magenta dark:text-warm-yellow font-semibold">{progress.milestone}</span>
        </p>
      </div>
    </div>
  );
