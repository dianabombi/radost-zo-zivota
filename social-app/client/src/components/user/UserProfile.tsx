...
const UserProfile: React.FC = () => {
  ...
  return (
    <div className="bg-charcoal-light border-2 border-warm-yellow rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 shadow-neon-yellow">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4 sm:mb-4">
        <div className="flex items-center space-x-3 sm:space-x-4 w-full sm:w-auto">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-lg sm:text-xl font-poppins font-bold text-warm-yellow truncate">
              {user.nickname}
            </h3>
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4 text-center">
        ...
        <div className="bg-deep-charcoal rounded-lg sm:rounded-xl p-2 sm:p-3">
          <div className="text-warm-yellow font-bold text-base sm:text-lg md:text-xl">
